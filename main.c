...
void Add_Button(char *name, int x, int y, int width, int height, float scale)
{
    ...
    //координат вершин элементов имени
     ...
     glColor3f(0.290, 0.290, 0.290); //цвет кнопки
     ...
     glColor3f(1.0, 1.0, 0.0); //цвет текста
    ...
    while (!bQuit)
    {
        ...
        else
        {
           ...
           /* glBegin(GL_TRIANGLES);
            ...
            Add_Button("Show", 1,0,150,50,3);
            Add_Button("Menu", 250,0,150,50,3);
            Add_Button("Exit", 500,0,150,50,3);
            glPopMatrix();
